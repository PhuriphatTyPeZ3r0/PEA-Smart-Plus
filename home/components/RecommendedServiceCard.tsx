...
const RecommendedServiceCard: React.FC<RecommendedServiceCardProps> = ({ title, description, imageSrc }) => {
  return (
    <div className="w-[78vw] max-w-[260px] shrink-0 bg-white rounded-2xl shadow-[0_1px_2px_rgba(16,24,40,0.05)] border border-slate-50 flex flex-col justify-start items-start overflow-hidden sm:w-[240px] md:w-full md:max-w-none">
