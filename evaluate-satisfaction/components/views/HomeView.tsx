      ...
      <div className="flex-1 overflow-y-auto no-scrollbar pb-[116px] sm:pb-[124px] lg:pb-[138px]">
        ...
        <div className="mx-auto w-full max-w-[1180px] px-4 pb-10 pt-8 sm:px-6 lg:px-10">
          ...
          <button
            ...
            className="mx-auto mt-10 flex h-12 w-full max-w-[320px] items-center justify-center rounded-full bg-[#A80689] px-6 text-base font-semibold text-white shadow-[0_10px_20px_-10px_rgba(168,6,137,0.55)] transition-all hover:brightness-105 active:scale-[0.98]"
          >
            ประเมินความพึงพอใจ
          </button>
        </div>
